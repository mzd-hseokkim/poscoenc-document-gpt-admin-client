...
import { CCard, CCardBody, CCardHeader, CNavLink } from '@coreui/react-pro';
...
const MarkerWithInfoWindow = ({ location }) => {
  ...
  return (
    <Marker onClick={() => setIsOpen(!isOpen)} position={location} title={location.title} label={location.label}>
      {isOpen && (
