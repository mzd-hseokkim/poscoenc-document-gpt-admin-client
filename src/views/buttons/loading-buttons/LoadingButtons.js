        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              CoreUI includes a buttons with built-in loading indicators. Indicate the loading state of the button
              bridging the gap between action and feedback..
            </p>
            <DocsExample href="components/loading-button">
              <CRow className="py-4 text-center">
                {['primary', 'secondary', 'success', 'danger', 'warning', 'info'].map((color, index) => (
                  <CCol md={2} key={index}>
            ...
            <DocsExample href="components/loading-button#grow">
              ...
              <CRow className="py-4 text-center">
                {['primary', 'secondary', 'success', 'danger', 'warning', 'info'].map((color, index) => (
                  <CCol md={2} key={index}>
                    <CLoadingButton color={color} spinnerType="grow" variant="outline" timeout={2000}>
                      Submit
                    </CLoadingButton>
                  </CCol>
                ))}
              ...
              <CRow className="py-4 text-center">
                {['primary', 'secondary', 'success', 'danger', 'warning', 'info'].map((color, index) => (
                  <CCol md={2} key={index}>
                    <CLoadingButton color={color} spinnerType="grow" variant="ghost" timeout={2000}>
                      Submit
                    </CLoadingButton>
                  </CCol>
                ))}
